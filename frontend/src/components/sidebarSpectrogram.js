...
export default function SidebarSpectrogram({ spectrogramData, loading }) {
  ...
  if (!spectrogramData  && !loading) {
    return (
    <div>
        <Typography className='sidebar-typography-padding'>No Spectrogram Data Available</Typography>
    </div>
    );
  }
