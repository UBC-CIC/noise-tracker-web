...
export class DBFlowStack extends Stack {
    constructor(scope: Construct, id: string, vpcStack: VpcStack, db: DBStack, props?: StackProps){
        ...
        const initializerLambda = new triggers.TriggerFunction(this, "noiseTracker-triggerLambda", {
            functionName: "noiseTracker-initializerFunction",
        ...
        initializerLambda.addToRolePolicy(
            new iam.PolicyStatement({
              ...
              resources: [
                `arn:aws:secretsmanager:${this.region}:${this.account}:secret:NoiseTracker/*`,
              ],
            })
        );
